...
default_nic_encryption_key   	?= 0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31
default_nic_authentication_key 	?= 0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32
default_nic_key_encryption_key	?= 0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33
# To provision passwords please fill the lines below
# with the associated meter passwords (maximum 32 characters)
# Example: password
default_nic_mr_password	?= wp_mr_pass
default_nic_us_password	?= wp_us_pass
default_nic_fu_password	?= wp_fu_pass
...
# Example : HDLC
# Example : WRAPPER
default_nic_interface_type ?= HDLC
