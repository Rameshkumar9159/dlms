 ...
 * @file
 *
 * Board definition for the Radientum reference board (v1.0)
 * It has a MX25R8035F external flash
 */
#ifndef BOARD_RADIENTUM_WP_V1_0_DUAL_MCU_BOARD_H_
#define BOARD_RADIENTUM_WP_V1_0_DUAL_MCU_BOARD_H_

// Serial port
#define BOARD_USART_ID                  1
#define BOARD_USART_TX_PORT             GPIO_PORTB
...
#define BOARD_GPIO_PIN_LIST            {{GPIO_PORTA, 7}, /* PA07 */\
                                        {GPIO_PORTA, 8}, /* PA08 */\
                                        {GPIO_PORTA, 7}} /* PA00. required by the dual_mcu app. usart wakeup pin (= BOARD_USART_RX) */
...
#define BOARD_GPIO_ID_USART_WAKEUP              2  // mapped to pin PA00
...
#endif /* BOARD_RADIENTUM_WP_V1_0_DUAL_MCU_BOARD_H_ */
