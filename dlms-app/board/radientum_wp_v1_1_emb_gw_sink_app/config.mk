...
# xG23 can not support UART DMA as it uses the USART block already reserved for the external flash driver
uart_use_dma=no

# This board is associated to the embedded gateway, which supports only one sink
mono_sink_gateway=yes
